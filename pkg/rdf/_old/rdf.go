// Package rdf implements native Golang support for RDF (Resource Description Framework).
//
// This package takes a resource-based approach to dealing with triples. This means
// that the graph is not a map or array of triples, but rather a map of resources.
// This allows for easy access by Subject URI and inlining of linked resources.
//
// This package is inspired by "github.com/knakk/rdf", but takes another approach to how RDF is encoded and decoded.
package rdf
...
var (
	...
	// GeoSparql
	geoWktLiteral = IRI{"http://www.opengis.net/ont/geosparql#wktLiteral"}
