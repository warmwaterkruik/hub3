...
func createESClient() (*elastic.Client, error) {
	options := []elastic.ClientOptionFunc{
		...
		elastic.SetRetrier(NewCustomRetrier()),                                   // set custom retrier that tries 5.
...
// Reset does a full reset of the index
